                    ...
                    <div class="vr__settings__box">
                        <div class="vr__settings__box__header border-bottom">
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <a href="{{ route('user.marinasPhotos') }}" class="btn btn-primary btn-sm">Slider</a>
                                </div>

                                <div class="col-md-6">
                                    <div class="col-auto" style="float: right;">
                                        <a href="{{ route('user.marinasPhotos')}}" class="btn btn-default me-2"><i class="fas fa-arrow-left me-2"></i> Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="vr__settings__box__body">
                            @include('frontend.user.marinas.tab.photo-add')
                        </div>
                    </div>
                </div>
            </div>
