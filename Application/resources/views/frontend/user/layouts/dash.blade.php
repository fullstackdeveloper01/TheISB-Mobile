        ...
        <aside class="vr__dash__sidebar">
            ...
            <div class="vr__dash__sidebar__content">
                ...
                <div class="vr__dash__sidebar__body">
                    ...
                    <a href="{{ route('user.marinasProfile') }}" @if (request()->segment(3) == 'marinasProfile' || request()->segment(3) == 'marinasBerthSpaces' || request()->segment(3) == 'marinasAmenities' || request()->segment(3) == 'marinasPhotos' || request()->segment(3) == 'marinasPhotosAdd' || request()->segment(3) == 'loginLogs') class="active" @endif>
                        <i class="fas fa-user-md fa-lg"></i> {{ lang('Marina Profile', 'user') }}
                    </a>
                    @if(userAuthInfo()->role == 1)
                        <a href="{{ route('user.operators') }}" @if (request()->segment(3) == 'operators' || request()->segment(3) == 'operator') class="active" @endif>
                            <i class="fas fa-user fa-lg"></i> {{ lang('Operators', 'user') }}
                        </a>
                    @endif
                    <a href="{{ route('user.berthSpace') }}" @if (request()->segment(3) == 'berthSpace') class="active" @endif>
                        <i class="fas fa-ship fa-lg"></i> {{ lang('Berth Space', 'user') }}
                    </a>
                    <a href="javascript:void()" @if (request()->segment(3) == 'users') class="active" @endif>
                        <i class="fas fa-users fa-lg"></i> {{ lang('Users', 'user') }}
                    </a>
                    <!-- <a href="javascript:void()" @if (request()->segment(3) == 'services') class="active" @endif>
                        <i class="fas fa-handshake fa-lg"></i> {{ lang('Services', 'user') }}
                    </a> -->
                    <a href="javascript:void()" @if (request()->segment(3) == 'bookings') class="active" @endif>
                        <i class="fas fa-book fa-lg"></i> {{ lang('Bookings', 'user') }}
                    </a>
                    <a href="javascript:void()" @if (request()->segment(3) == 'reports') class="active" @endif>
                        <i class="fas fa-file fa-lg"></i> {{ lang('Reports', 'user') }}
                    </a>
                    {{--
