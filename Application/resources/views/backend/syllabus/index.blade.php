...
@section('title', __('Class Syllabus'))
@section('link', route('admin.syllabus.create'))
@section('content')	
							...
							<td>
								<div class="text-end">
									...
									<ul class="dropdown-menu dropdown-menu-sm-end" data-popper-placement="bottom-end">
										<li>
											<a class="dropdown-item" href="{{ route('admin.syllabus.edit', $syllabus->id) }}">
										...
										<li>
											<form action="{{ route('admin.syllabus.destroy', $syllabus->id) }}" method="POST">
												@csrf @method('DELETE')
