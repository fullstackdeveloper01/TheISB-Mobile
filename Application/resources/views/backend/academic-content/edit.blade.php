...
@section('title', 'Edit academic content')
@section('back', route('admin.academicContent.index'))
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <form id="vironeer-submited-form" action="{{ route('admin.academicContent.update', $syllabus->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-lg-4 my-1">
                                ...
                                <input type="checkbox" name="status" data-toggle="toggle" data-on="{{ __('Active') }}"
                                    data-off="{{ __('Banned') }}" @if ($syllabus->status) checked @endif>
                            </div>
                        </div>
                    </div>
                </div>
