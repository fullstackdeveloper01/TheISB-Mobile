        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="mb-3">
                    ...
                    <select name="country" class="form-select" disabled required>
                        <option value=""></option>
            ...
            <div class="col-lg-6 mb-3">
                <div class="mb-3">
                    ...
                    <input type="text" name="zip" class="form-control" disabled value="{{ @$user->address->zip }}" required>
                </div>
            </div>            
            <div class="col-lg-6 mb-3">
...
<div class="row">
    <div class="col-lg-12 dash__forms mb-3">
        ...
        <textarea name="description" rows="3" class="form-control" disabled required>{{ @$marinaDetail->description }}</textarea>
    </div>
    <div class="col-lg-6">
        <div class="mb-3">
            <label class="form-label">{{ __('Number of Berth') }} :<span class="red">*</span></label>
            <input type="number" name="number_of_berth" maxlength="3" class="form-control" disabled value="{{ @$marinaDetail->number_of_berth }}" required>
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-3">
            <label class="form-label">{{ __('Type of Berth') }} :<span class="red">*</span></label>
            <input type="text" name="type_of_berth" class="form-control" disabled value="{{ @$marinaDetail->type_of_berth }}" required>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <div class="mb-3">
            ...
            <input type="number" name="max_draft" maxlength="3" class="form-control" disabled value="{{ @$marinaDetail->max_draft }}" required>
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-3">
            <label class="form-label">{{ __('Max Length') }} :<span class="red">*</span></label>
            <input type="number" name="max_length" maxlength="3" class="form-control" disabled value="{{ @$marinaDetail->max_length }}" required>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-lg-12 mb-3 dash__forms">
        ...
        <textarea name="cancellation_policy" rows="3" class="form-control" disabled required>{{ @$marinaDetail->cancellation_policy }}</textarea>
    </div>
    <div class="col-lg-12 mb-3 dash__forms">
        <label class="form-label">{{ __('Getting to Marina') }} :<span class="red">*</span></label>
        <textarea name="getting_to_marina" rows="3" class="form-control" disabled required>{{ @$marinaDetail->getting_to_marina }}</textarea>
    </div>
</div>
<div class="row mb-3">
    <div class="col-lg-12">
        <div class="mb-3">
            ...
            <input type="text" name="address_1" value="{{ @$user->address->address_1 }}" id="full_address" class="form-control" disabled required onFocus="geolocate()">
