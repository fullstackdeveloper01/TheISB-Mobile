...
@section('title', __('Marinas'))
@section('link', route('admin.marinas.create'))
@section('content')
    <div class="row g-3 mb-4">
        <div class="col-12 col-lg-6 col-xxl-6">
            <div class="vironeer-counter-box bg-success">
                <h3 class="vironeer-counter-box-title">{{ __('Active Marinas') }}</h3>
        ...
        <div class="col-12 col-lg-6 col-xxl-6">
            <div class="vironeer-counter-box bg-danger">
                <h3 class="vironeer-counter-box-title">{{ __('Inactive Marinas') }}</h3>
        ...
        <div class="card-header p-3 border-bottom-small">
            <form action="{{ request()->url() }}" method="GET">
                <div class="input-group vironeer-custom-input-group">
                    <input type="text" name="search" class="form-control" placeholder="{{ __('Search on marinas...') }}"
                ...
                <div class="table-responsive">
                    <table class="vironeer-normal-table table w-100">
                        <thead>
                            <tr>
                                <th class="tb-w-3x">#</th>
                                <th class="tb-w-20x">{{ __('Marina details') }}</th>
                                    ...
                                    <td>
                                        <div class="vironeer-user-box">
                                            ...
                                            <a href="javascript::void()">
                                                <span class="profileImage">{{ substr($user->firstname, 0, 1); }}{{substr($user->firstname, 1, 1);}} </span>
                                            </a>
                                            <div>
                                                <a class="text-reset"
                                                    href="{{ route('admin.marinas.edit', $user->id) }}">{{ $user->firstname . ' ' . $user->lastname }} @if($user->city_id > 0)({{ @$user->city->name }}) @endif</a>
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-sm-end"
                                                ...
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.marinas.edit', $user->id) }}"><i
                                                ...
                                                {{--<li>
                                                    <form action="{{ route('admin.marinas.destroy', $user->id) }}"
                                                        method="POST">
                                                        @csrf @method('DELETE')
