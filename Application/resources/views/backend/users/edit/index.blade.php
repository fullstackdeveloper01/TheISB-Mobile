                ...
                <div class="card custom-card mb-3">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-4 my-1" style="display: none;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3" style="display: none;">
                            <label class="form-label">{{ __('Username') }} :<span
                                    class="red">*</span></label>
                            <input type="username" name="username" class="form-control" value="{{ $user->firstname }}">
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        {{--<button class="btn btn-dark" type="button" data-bs-toggle="modal" data-bs-target="#sendMailModal">
                                            <i class="far fa-paper-plane me-2"></i>{{ __('Send Email') }}</button>--}}
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label class="form-label">{{ __('Mobile number') }} :<span class="red">*</span></label>
