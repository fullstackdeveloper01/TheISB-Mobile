    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-12 col-lg-6 col-xxl-6">
            <div class="vironeer-counter-box bg-danger">
                <h3 class="vironeer-counter-box-title">{{ __('Inactive Users') }}</h3>
                    ...
                    <table class="vironeer-normal-table table w-100">
                        <thead>
                            <tr>
                                ...
                                <th class="tb-w-5x">{{ __('Mobile number') }}</th>
                                ...
                                <th class="tb-w-3x text-center">{{ __('Registered By') }}</th>
                        ...
                        <tbody>
                            @foreach ($users as $key => $user)
                                <tr>
                                    ...
                                    <td>
                                        <div class="vironeer-user-box">
                                            ...
                                            <a href="javascript::void()">
                                                <span class="profileImage">{{ substr($user->firstname, 0, 1); }}{{substr($user->lastname, 0, 1);}} </span>
                                            </a>
                                            <div>
                                                <a class="text-reset"
                                    ...
                                    <td class="text-center"><i class="fa fa-desktop fa-2x text-info"></i></td>
