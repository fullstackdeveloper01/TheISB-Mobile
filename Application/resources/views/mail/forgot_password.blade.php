<!DOCTYPE html>
	...
	<head>
		...
		<title>Framesport Emailer || Registration Successfully</title>
								...
								<table border="0" style="margin:0; width:100%" cellpadding="0" cellspacing="0">
									...
									<tr>
										...
										<td class="content" style="padding:40px 40px;">
											...
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#333; margin-top:0">Forgot your password?</p>

											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#333; margin-top:0">We received a request to reset the password for your account.</p>
											...
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#333;">If any Questions? Please send us an email at <a href="javascript:void(0);" style="color:#006ba4!important;">info@framesport.com</a> and we will revert as soon as possible.</p>
